...
- **Tür:** Klasik **ball sort**; bir tüpte **birden fazla renk** üst üste olabilir. Beş One rengi (Puls…Aura gradyanları).
- **Kapasite:** Her tüpte en fazla **5** blok; **2 boş** yardımcı tüp (toplam 7).
- **Hamle:** Önce kaynak tüpe, sonra hedef tüpe dokun; **en üstteki bitişik aynı renk yığını** tek hamlede taşınır (hedef boş veya üstteki renkle uyumlu olmalı).
- **Kazanma:** İlk beş tüpte soldan **Puls → … → Aura** (her birinde 5 blok); son iki tüp boş. Başlangıç: **karışık, çözülebilir** hazır seviyeler (tüp içinde çok renk); seviye seti yayına alınmadan BFS ile hedefe ulaşılabilirliği doğrulanır.
